...
namespace AvitoMusicInstrumentsBot.InstrumentAnalyzers
{
    public class TypeIdentifier : Comparer
    {
        ...
        {
            _bassKeywords = File.ReadAllLines(ConfigurationManager.AppSettings["bassPath"]);
            _classicKeywords = File.ReadAllLines(ConfigurationManager.AppSettings["classicPath"]);
            _elecricKeywords = File.ReadAllLines(ConfigurationManager.AppSettings["electricPath"]);
            _acousticKeywords = File.ReadAllLines(ConfigurationManager.AppSettings["acousticPath"]);
            _folkKeywords = File.ReadAllLines(ConfigurationManager.AppSettings["folkSamples"]);
            _iDontCareKeywords = File.ReadAllLines(ConfigurationManager.AppSettings["iDontCarePath"]);
        }
