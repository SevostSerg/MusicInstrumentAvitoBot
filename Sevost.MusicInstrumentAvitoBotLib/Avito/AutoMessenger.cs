...
namespace AvitoTelegramBot.Sevost.MusicInstrumentAvitoBot.Avito
{
    internal static class AutoMessenger
    {
        ...
        private static bool WithDelivery
        {
            get
            {
                ...
                return screenInfo.Text.Contains("Авито Доставка") && screenInfo.Text.Contains("Гарантия возврата денег, если товар\r\nне подойдёт");
            }
        }
